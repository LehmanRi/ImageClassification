...
class AlexNet(nn.Module):
    def __init__(self, num_classes=1000):  # Changed to 128 classes
        ...
        for epoch in range(num_epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(),
                           'best_alexnet_weights.pth')  # Save only the model's weights (state_dict # Save the model
